    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div class="col-12">
            ...
            <form action="/movie" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <label for="cover_image" class="col-sm-2 col-form-label">Poster</label>
                    <div class="col-sm-10">
                        <input type="file" name="cover_image" class="form-control @error('poster') is-invalid @enderror" id="poster">
